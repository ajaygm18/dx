...
class IndianMarketDataLoader:
    ...
    # Indian market focus - IRFC and Reliance Industries
    INDIAN_MARKET = {
        'IRFC': 'IRFC.NS',           # Indian Railway Finance Corporation (NSE) - Primary focus
        'RELIANCE': 'RELIANCE.NS',    # Reliance Industries (NSE) - Backup support
    }
    ...
    def download_market_data(self, market_code: str = "IRFC", start_date: str = "2005-01-01", end_date: str = "2022-03-31") -> pd.DataFrame:
        """
        Download IRFC or Reliance Industries data (Indian market).
        
        Args:
            market_code: Market code ('IRFC' or 'RELIANCE' supported)
